  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'provider-overview', href: '/provider/overview', label: 'Vista global', icon: 'LayoutGrid', order: 1 },
        { id: 'provider-new', href: '/provider/new', label: 'Nueva empresa', icon: 'PlusCircle', order: 2 },
        { id: 'provider-plans', href: '/provider/plans', label: 'Planes', icon: 'CreditCard', order: 3 },
        { id: 'provider-usage', href: '/provider/usage', label: 'Datos de uso', icon: 'BarChart3', order: 4 },
        { id: 'provider-backups', href: '/provider/backups', label: 'Backups', icon: 'Database', order: 5 },
        { id: 'provider-feedback', href: '/provider/feedback', label: 'Sugerencias', icon: 'Lightbulb', order: 6 },
      ],
    },
  ],
};
