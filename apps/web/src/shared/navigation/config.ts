  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'provider-metrics', href: '/provider/metrics', label: 'Métricas de negocio', icon: 'TrendingUp', order: 4 },
        { id: 'provider-usage', href: '/provider/usage', label: 'Datos de uso', icon: 'BarChart3', order: 5 },
