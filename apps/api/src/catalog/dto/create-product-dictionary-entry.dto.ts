...
export class CreateProductDictionaryEntryDto {
  @ApiProperty({
    ...
    description: 'Término o frase que los clientes escriben al preguntar por productos',
    minLength: 1,
    maxLength: 200,
  })
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'ID de la categoría a la que se asocia este término (opcional)',
  })
  @IsOptional()
  @IsUUID('4')
  categoryId?: string;
