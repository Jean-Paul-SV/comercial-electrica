...
const ALL_PERMISSION_SLUGS = [
  'sales:create', 'sales:read', 'sales:update', 'sales:delete', 'sales:manage',
  'quotes:create', 'quotes:read', 'quotes:update', 'quotes:delete', 'quotes:manage',
  'returns:create', 'returns:read', 'returns:update', 'returns:delete',
  'cash:create', 'cash:read', 'cash:update', 'cash:manage',
  ...
  'catalog:create', 'catalog:read', 'catalog:update', 'catalog:delete', 'catalog:manage',
  'customers:create', 'customers:read', 'customers:update', 'customers:delete',
  'suppliers:create', 'suppliers:read', 'suppliers:update', 'suppliers:delete',
  'purchases:create', 'purchases:read', 'purchases:update', 'purchases:manage',
  'supplier-invoices:create', 'supplier-invoices:read', 'supplier-invoices:update', 'supplier-invoices:manage',
  'reports:read', 'reports:manage',
  'audit:read', 'audit:manage',
  'backups:read', 'backups:manage',
  'dian:read', 'dian:manage',
