...
async function main() {
  ...
  const standardPlans = [
    ...
    { slug: 'basico-con-dian', name: 'Plan Básico con DIAN', description: 'Facturación electrónica DIAN, ventas e inventario. Backup 3 días a la semana. Sin reportes.', priceMonthly: 169_000, priceYearly: 1_620_000, maxUsers: 3, moduleCodes: ['core', 'inventory', 'electronic_invoicing', 'backups'] as const },
