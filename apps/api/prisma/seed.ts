...
const MODULE_CODES = [
  ...
  'audit',
  'backups',
  'ai', // IA: resumen dashboard en lenguaje natural. Solo Premium y Enterprise.
] as const;
...
async function main() {
  ...
  const standardPlans = [
    ...
    { slug: 'premium-sin-dian', name: 'Plan Premium sin DIAN', description: 'Todo lo del Básico más reportes e IA. Backup 2 días a la semana. Sin facturación electrónica DIAN.', priceMonthly: 120_000, priceYearly: 1_150_000, maxUsers: 5, moduleCodes: ['core', 'inventory', 'advanced_reports', 'backups', 'ai'] as const },
    { slug: 'premium-con-dian', name: 'Plan Premium con DIAN (Recomendado)', description: 'DIAN, reportes, IA y proveedores. Backup diario. Para equipos que facturan electrónicamente.', priceMonthly: 200_000, priceYearly: 1_920_000, maxUsers: 8, moduleCodes: ['core', 'inventory', 'suppliers', 'electronic_invoicing', 'advanced_reports', 'backups', 'ai'] as const },
